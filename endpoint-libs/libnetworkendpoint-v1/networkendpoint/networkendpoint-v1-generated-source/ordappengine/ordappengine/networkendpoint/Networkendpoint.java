...
public class Networkendpoint extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  /**
   * Create a request for the method "getAdminSubmissions".
   *
   * This request holds the parameters needed by the the networkendpoint server.  After setting any
   * optional parameters, call the {@link GetAdminSubmissions#execute()} method to invoke the remote
   * operation.
   *
   * @return the request
   */
  public GetAdminSubmissions getAdminSubmissions() throws java.io.IOException {
    GetAdminSubmissions result = new GetAdminSubmissions();
    initialize(result);
    return result;
  }

  public class GetAdminSubmissions extends NetworkendpointRequest<Void> {
     ...
     * This request holds the parameters needed by the the networkendpoint server.  After setting any
     * optional parameters, call the {@link GetAdminSubmissions#execute()} method to invoke the remote
     * operation. <p> {@link GetAdminSubmissions#initialize(com.google.api.client.googleapis.services.
     * AbstractGoogleClientRequest)} must be called to initialize this instance immediately after
     * invoking the constructor. </p>
     *
     * @since 1.13
     */
    protected GetAdminSubmissions() {
    ...
    @Override
    public GetAdminSubmissions setAlt(java.lang.String alt) {
      return (GetAdminSubmissions) super.setAlt(alt);
    }

    @Override
    public GetAdminSubmissions setFields(java.lang.String fields) {
      return (GetAdminSubmissions) super.setFields(fields);
    }

    @Override
    public GetAdminSubmissions setKey(java.lang.String key) {
      return (GetAdminSubmissions) super.setKey(key);
    }

    @Override
    public GetAdminSubmissions setOauthToken(java.lang.String oauthToken) {
      return (GetAdminSubmissions) super.setOauthToken(oauthToken);
    }

    @Override
    public GetAdminSubmissions setPrettyPrint(java.lang.Boolean prettyPrint) {
      return (GetAdminSubmissions) super.setPrettyPrint(prettyPrint);
    }

    @Override
    public GetAdminSubmissions setQuotaUser(java.lang.String quotaUser) {
      return (GetAdminSubmissions) super.setQuotaUser(quotaUser);
    }

    @Override
    public GetAdminSubmissions setUserIp(java.lang.String userIp) {
      return (GetAdminSubmissions) super.setUserIp(userIp);
    }

    @Override
    public GetAdminSubmissions set(String parameterName, Object value) {
      return (GetAdminSubmissions) super.set(parameterName, value);
    }
  }
