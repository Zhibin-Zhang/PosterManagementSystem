...
public class Networkendpoint extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class GetSubmissions extends NetworkendpointRequest<Void> {

    private static final String REST_PATH = "void/{emailAddress}";
    ...
    protected GetSubmissions(java.lang.String emailAddress) {
      super(Networkendpoint.this, "GET", REST_PATH, null, Void.class);
   ...
   *
   * @param status
   * @param content the {@link ordappengine.ordappengine.networkendpoint.model.BlobKey}
   * @return the request
   */
  public UpdateStatus updateStatus(java.lang.String status, ordappengine.ordappengine.networkendpoint.model.BlobKey content) throws java.io.IOException {
    UpdateStatus result = new UpdateStatus(status, content);
    initialize(result);
    return result;
  }
  ...
  public class UpdateStatus extends NetworkendpointRequest<Void> {
    ...
    private static final String REST_PATH = "void/{status}";
     ...
     * @since 1.13
     */
    protected UpdateStatus(java.lang.String status, ordappengine.ordappengine.networkendpoint.model.BlobKey content) {
      super(Networkendpoint.this, "PUT", REST_PATH, content, Void.class);
