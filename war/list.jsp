...
<div id="dialog">
	<form id="register-form">
			...
			// Session is not registered to administrator
			out.println("You do not have enough privileges to access this page!");
		}
	} else {
	...
	response.sendRedirect("/index.jsp?error=no_session");
}
